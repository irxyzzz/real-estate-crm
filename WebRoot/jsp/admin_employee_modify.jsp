...
<html>
  ...
  <body >
  	...
  	<form action="employeeManage.do" method="post">
  		...
  		<input type="hidden" name="action" value="adminModify">
  		...
  		<table>
  			...
  			<tr>
  				<th scope="row">姓名</th>
  				<td><input type="text" name="name" value="${employee.name }" maxlength="5"/></td>
  			</tr>
  			<tr>
  				<th scope="row">密码</th>
  				<td><input type="text" name="password" value="${employee.password }" maxlength="10"/></td>
  			</tr>
  			<tr>
  				<th scope="row">性别</th>
  				<td>
  			...
  			<tr>
  				<th scope="row">住址</th>
  				<td><input type="text" name="address" value="${employee.address }" maxlength="50"/> </td>
  			</tr>
  			<tr>
  				<th scope="row">兴趣</th>
  				<td>
  			...
  			<tr>
  				<th scope="row">电话</th>
  				<td><input type="text" name="phone" value="${employee.phone}" maxlength="15"/> </td>
  			</tr>
  			<tr>
  				<th scope="row">E-Mail</th>
  				<td><input type="text" name="email" value="${employee.email}" maxlength="30"/></td>
  			</tr>
  			<tr>
  				<th scope="row">部门</th>
  				<td>
  			...
  			<tr>
  				...
  				<td>
  					...
  					<c:if test="${employee.isManager == false}">
  						<input type="radio" name="isManager" value="Y" /><label>是</label>
  						<input type="radio" name="isManager" value="N" checked="checked"/><label>否</label>
  					</c:if>
  				</td>
  			</tr>
  			<tr>
  				<th scope="row">邮编</th>
  				<td><input type="text" name="post" value="${employee.post}" maxlength="6"/></td>
  			</tr>
  			<tr>
  				<td></td>

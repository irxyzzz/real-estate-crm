...
<html>
  <head>
    ...
    <script type="text/javascript" src="../js/customer_contact.js" ></script>
  </head>
  <body>
  	...
  	<div class="modify_block" id="modifier">
  		...
  		<form action="customerManage.do" method="post" id="addContactForm">
  		...
  		<div class="table_footer ui-helper-clearfix">
            <span>添加单项回复</span>
            <a onclick="$('#addContactForm')[0].submit();" class="btn_submit" id="add_reset">提交</a>
        </div>
  		</form>
  	</div>
